...
//        Log.i("Cart created", cart + " ");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pid.setText("Product_ID - " + productData.getProductId());

        TextView category = (TextView) findViewById(R.id.category);
        category.setText("Category - " + productData.getCategory());

        TextView maincategory = (TextView) findViewById(R.id.mcategory);
        maincategory.setText("Main_Category - "+productData.getMainCategory());


        TextView name = (TextView) findViewById(R.id.name);
        name.setText("Name -"+productData.getName());

        TextView sname = (TextView) findViewById(R.id.sname);
        sname.setText("Supplier_Name - "+ productData.getSupplierName());

/*
        TextView wmeasure = (TextView) findViewById(R.id.wmeasure);
        wmeasure.setText("Weight_Measure - " + productData.getWeightMeasure());
*/

        TextView wunit = (TextView) findViewById(R.id.wunit);
        wunit.setText("Weight_Unit - " +productData.getWeightUnit());

        TextView des = (TextView) findViewById(R.id.descrition);
        des.setText("Description - "+productData.getDescription());
        ...
        status.setText("Status - "+productData.getStatus());

        TextView qty = (TextView) findViewById(R.id.quantity);
        qty.setText("Quantity - " + productData.getQuantity() + " ");

        TextView uom = (TextView) findViewById(R.id.uom);
        uom.setText("UOM - " +productData.getUoM());

        TextView currencymode = (TextView) findViewById(R.id.currencycode);
        currencymode.setText("Currency_Mode - "+productData.getCurrencyCode());

        TextView price = (TextView) findViewById(R.id.price);
        price.setText("Price - "+ productData.getPrice());

        TextView width = (TextView) findViewById(R.id.width);
        width.setText("Width - " + productData.getWidth());

        TextView height = (TextView) findViewById(R.id.height);
        height.setText("Height - "+ productData.getHeight());

        TextView depth = (TextView) findViewById(R.id.depth);
        depth.setText("Depth - "+productData.getDepth());

        TextView dim = (TextView) findViewById(R.id.dimUnit);
        dim.setText("Dimensions - " + productData.getDimUnit());
...
//                            Toast.makeText(Hero.this, "C =========== " + c , Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                if (Global.cart.size() >= 1) {
                    if (r >= c) {
                        ...
                        r++;
                        c--;
//                        Toast.makeText(Hero.this, "C == " + c +" R == " + r, Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Hero.this, "removed from cart " + productData.getProductId() + "\n removed" + r, Toast.LENGTH_SHORT).show();
                    }
